...
- ****TLG301****
  - Severity: Error
  - Trigger: Return type is not `InlineKeyboardMarkup` or `ReplyKeyboardMarkup`
- ****TLG302****
  - Severity: Error
  - Trigger: Attribute is not supported for the chosen return type
- ****TLG303****
  - Severity: Error
  - Trigger: Member is not declared as `partial`
- ****TLG304****
  - Severity: Error
  - Trigger: Method has a body or expression body
- ****TLG306****
  - Severity: Error
  - Trigger: Property has a setter, initializer, or expression body
- ****TLG307****
  - Severity: Error
  - Trigger: Property `get` accessor has a body

> Keyboard markup diagnostics use the `TLG301+` range to avoid collision with `MightAwaitAnalyzer` (`TLG201`).
